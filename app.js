...
var adminCourse111Ctrl=require("./controllers/adminCourse111Ctrl.js");
//创建app
var app = express();
//链接数据库，斜杠后面是数据库的名字
mongoose.Promise = global.Promise;
mongoose.connect('mongodb://localhost/ElectiveCourseRegisterationSystem', { useNewUrlParser: true, useUnifiedTopology: true})
